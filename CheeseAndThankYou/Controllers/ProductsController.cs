...
namespace CheeseAndThankYou.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Name,StinkRating,Description,Price,Size,CategoryId")] Product product, IFormFile? Photo)
        {
            ...
            {
                // Check for a file upload, and process if any.
                if (Photo != null)
                {
            ...
            ViewData["CategoryId"] = new SelectList(_context.Categories, "CategoryId", "CategoryId", product.CategorId);
            return View(product);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["CategoryId"] = new SelectList(_context.Categories.OrderBy(c => c.Name), "CategoryId", "Name", product.CategorId);
            return View(product);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,Name,StinkRating,Description,Price,Size,CategorId")] Product product, IFormFile? Photo, String? CurrentPhoto)
        {
        ...
        private string UploadPhoto(IFormFile Photo)
        {
            ...
            // Create a unique file name to prevent overwriting using (GUID)
            // ex - photo.jpg => a33984-photo.jpg
